...
-- Schéma complet de la plateforme SEED — ISRA / CNRA
-- Flyway migration gérée par catalog-service (schema owner)
-- Convention : CREATE TABLE IF NOT EXISTS → idempotent
-- ============================================================
...
CREATE TABLE IF NOT EXISTS message (
  ...
  type            VARCHAR(20) NOT NULL DEFAULT 'TEXT'
                  CHECK (type IN ('TEXT','IMAGE','FICHIER','AUDIO')),
  contenu         TEXT,
  url_media       TEXT,
